      ...
      <div className="main-content-body">
              ...
              <div className="card-body">
                <div className="d-flex">
                  <div className="my-auto">
                    <svg
                      enableBackground="new 0 0 469.682 469.682"
                      version="1.1"
                      className="mr-4 ht-60 wd-60 my-auto primary"
                      viewBox="0 0 469.68 469.68"
                  ...
                  <div className="project-content">
                    ...
                    <ul>
                      <li>
                        <strong>Processing</strong> <span>5</span>
                      </li>
                      <li>
                        <strong>Paid</strong> <span>56</span>
                      </li>
                    </ul>
                  </div>
                </div>
            ...
            <div className="card  overflow-hidden project-card">
              <div className="card-body">
                <div className="d-flex">
                  <div className="my-auto">
                    <svg
                      enable-background="new 0 0 438.891 438.891"
                      className="mr-4 ht-60 wd-60 my-auto danger"
                      version="1.1"
                      viewBox="0 0 438.89 438.89"
                      xmlns="http://www.w3.org/2000/svg"
                    >
                  ...
                  <div className="project-content">
                    ...
                    <ul>
                      <li>
                        <strong>Processing</strong> <span>42</span>
                      </li>
                      <li>
                        <strong>Completed</strong> <span>23</span>
                      </li>
                    </ul>
                  </div>
                </div>
            ...
            <div className="card overflow-hidden project-card">
              <div className="card-body">
                <div className="d-flex">
                  <div className="my-auto">
                    <svg
                      enable-background="new 0 0 477.849 477.849"
                      className="mr-4 ht-60 wd-60 my-auto success"
                      version="1.1"
                      viewBox="0 0 477.85 477.85"
                      xmlns="http://www.w3.org/2000/svg"
                    >
                  ...
                  <div className="project-content">
                    ...
                    <ul>
                      <li>
                        <strong>Processing</strong> <span>2</span>
                      </li>
                      <li>
                        <strong>Accepted</strong> <span>16</span>
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="d-flex">
                  <div className="my-auto">
                    <svg
                      ...
                      className="mr-4 ht-60 wd-60 my-auto warning"
                      version="1.1"
                      viewBox="0 0 512 512"
                      xmlns="http://www.w3.org/2000/svg"
                    >
                  ...
                  <div className="project-content">
                    ...
                    <ul>
                      <li>
                        <strong>Earnings</strong> <span>$15,425</span>
                      </li>
                      <li>
                        <strong>Expensive</strong> <span>$8,147</span>
                      </li>
                    </ul>
                  </div>
                </div>
          ...
          <div className="col-xl-8 col-lg-12 col-md-12 col-sm-12">
            <div className="card overflow-hidden">
              <div className="card-header bg-transparent pd-b-0 pd-t-20 bd-b-0">
                ...
                <p className="tx-12 text-muted mb-2">
                  The Project Budget is a tool used by project managers to estimate the total cost
                  of a project. A project budget template includes a detailed estimate of all costs.
                  <a href="">Learn more</a>
                </p>
              </div>
              <div className="card-body pd-y-7">
                <div
                ...
                <div className="area chart-legend mb-0">
                  <div>
                    <i className="mdi mdi-album text-primary mr-2" /> Total Budget
                  </div>
                  <div>
                    <i className="mdi mdi-album text-pink mr-2" />
                    Amount Used
                  </div>
                </div>
                <canvas
                  ...
                  width="1260"
                  height="630"
                  style={{ display: 'block', height: '315px', width: '630px' }}
                />
              </div>
            </div>
          </div>
          <div className="col-sm-12 col-md-12 col-lg-12 col-xl-4">
            <div className="card overflow-hidden">
              <div className="card-body pb-3">
                ...
                <p className="tx-12 text-muted mb-3">
                  In project, a task is an activity that needs to be accomplished within a defined
                  period of time or by a deadline. <a href="">Learn more</a>
                </p>
                  ...
                  <table className="table table-hover table-bordered mb-0 text-md-nowrap text-lg-nowrap text-xl-nowrap  ">
                    ...
                    <tbody>
                      <tr>
                        <td>
                          <div className="project-names">
                            ...
                            <p className="d-inline-block font-weight-semibold mb-0">UI Design</p>
                          </div>
                        </td>
                        <td>
                      ...
                      <tr>
                        <td>
                          <div className="project-names">
                            <h6 className="bg-pink-transparent text-pink d-inline-block text-center mr-2">
                              R
                            </h6>
                            <p className="d-inline-block font-weight-semibold mb-0">Landing Page</p>
                          </div>
                        </td>
                        <td>
                      ...
                      <tr>
                        <td>
                          <div className="project-names">
                            <h6 className="bg-success-transparent text-success d-inline-block mr-2 text-center">
                              W
                            </h6>
                      ...
                      <tr>
                        <td>
                          <div className="project-names">
                            <h6 className="bg-purple-transparent text-purple d-inline-block mr-2 text-center">
                              P
                            </h6>
                            <p className="d-inline-block font-weight-semibold mb-0">
                              Product Development
                        ...
                        <td>
                          <div className="badge badge-teal">on-going</div>
                        </td>
                      </tr>
                      <tr>
                        <td>
                          <div className="project-names">
                            <h6 className="bg-danger-transparent text-danger d-inline-block mr-2 text-center">
                              L
                            </h6>
                            <p className="d-inline-block font-weight-semibold mb-0">Logo Design</p>
                          </div>
                        </td>
                        <td>
                          <div className="badge badge-success">Completed</div>
        ...
        <div className="row row-sm">
          <div className="col-lg-6 col-xl-4 col-md-12 col-sm-12">
            <div className="card overflow-hidden latest-tasks">
              <div className="">
                <div className="d-flex justify-content-between pl-4 pt-4 pr-4">
              ...
              <div className="card-body pt-3">
                <div className="tab-content">
                  <div className="tab-pane fade active show" id="tasktab-1" role="tabpanel">
                    <div className="">
                      <div className="tasks">
                        <div className=" task-line primary active">
                          {' '}
        ...
        <div className="col-sm-12 col-md-12 col-lg-6 col-xl-4">
          <div className="card overflow-hidden">
            <div className="card-header pb-0">
              <div className="d-flex justify-content-between">
                <h4 className="card-title mg-b-10 mt-2">Projects Workload</h4>
                <i className="mdi mdi-dots-horizontal text-gray" />
              </div>
              <p className="tx-12 text-muted mb-0">
                In the Project Workload report, their remaining assignments, completion dates,
                whether their work is at-risk. <a href="">Learn more</a>
              </p>
            </div>
            <div className="card-body">
              <div className="">
                <div className="row justify-content-md-center">
                  <div className="col-sm-12">
                    <div className="">
                      <canvas
                        id="chartDonut"
                        className="ht-175 drop-shadow mx-auto"
                        width="340"
                        height="340"
                        style={{ display: 'block', height: '170px', width: '170px' }}
                      >
                        <ul className="1-legend">
                          <li>
                            <span style={{ backgroundColor: '#3858f9' }} />
                            External
                          </li>
                          <li>
                            <span style={{ backgroundColor: '#f09819' }} />
                            Internal
                          </li>
                          <li>
                            <span style={{ backgroundColor: '#3cba92' }} />
                            Other
                          </li>
                        </ul>
                      </canvas>
              ...
              <div className="pt-3">
                <div className="row ">
                  <div className="col-sm-8 ">
                    <h6 className="mb-0 tx-15 d-flex">
                      <span className="legend bg-primary-gradient brround" />
                      <span className="ml-3">40.32%</span>
                    </h6>
                    <p className="text-muted  tx-13 mb-0 ml-4">External</p>
                  </div>
              ...
              <div className="pt-3">
                <div className="row ">
                  <div className="col-sm-8 ">
                    <h6 className="mb-0 tx-15 d-flex">
                      <span className="legend bg-warning-gradient brround" />
                      <span className="ml-3">40.73%</span>
                    </h6>
                    <p className="text-muted tx-13 mb-0 ml-4 ">Internal</p>
                  </div>
                  <div className="col-sm-4 ">
                    <span id="sparkel2">
                      <canvas
              ...
              <div className="pt-3">
                <div className="row ">
                  <div className="col-sm-8 ">
                    <h6 className="mb-0 tx-15 d-flex">
                      <span className="legend bg-success-gradient brround" />
                      <span className="ml-3">50.12%</span>
                    </h6>
                    <p className="text-muted tx-13 mb-0 ml-4">Other</p>
                  </div>
                  <div className="col-sm-4 ">
                    <span id="sparkel3">
                      <canvas
        ...
        <div className="col-lg-12 col-xl-4 col-md-12 col-sm-12">
          <div className="card card-dashboard-events">
            <div className="card-header pb-0">
              <div className="d-flex justify-content-between">
                <h4 className="card-title mg-b-10">Upcoming Events</h4>
                <i className="mdi mdi-dots-horizontal text-gray" />
              </div>
              <p className="tx-12 text-muted mb-0">
                It had the latest news and notes from the championship, while previewing the
                upcoming event.. <a href="">Learn more</a>
              </p>
            </div>
            <div className="card-body">
              <div className="list-group ">
                <div className="list-group-item border-top-0">
                  <div className="event-indicator bg-primary-gradient" />
                  <label>
                    Nov 20
                    <span>Tuesday</span>
                  </label>
                  ...
                  <p>
                    <strong>8AM - 4PM</strong> Bay Area, San Francisco
                  </p>
                  <small>
                    <span className="tx-danger">Sold Out</span> (3000 tickets sold)
                  </small>
                </div>
                <div className="list-group-item">
                  <div className="event-indicator bg-danger-gradient" />
                  <label>
                    Nov 23
                    <span>Friday</span>
                  </label>
                  ...
                  <p>
                    <strong>8AM - 5PM</strong> Singapore
                  </p>
                  <small>
                    <span className="tx-warning">Sold Out Soon</span> (12 tickets left)
                  </small>
                </div>
                <div className="list-group-item border-bottom-0">
                  <div className="event-indicator bg-info-gradient" />
                  <label>
                    Nov 23
                    <span>Friday</span>
                  </label>
                  ...
                  <small>
                    <span className="tx-success">Free Registration</span> (Limited seats only)
                  </small>
                </div>
              </div>
            </div>
        ...
        <div className="row row-sm ">
          <div className="col-md-12 col-xl-12">
            <div className="card overflow-hidden review-project">
              <div className="card-body">
                <div className="d-flex justify-content-between">
                  <h4 className="card-title mg-b-10">All Projects</h4>{' '}
                  <i className="mdi mdi-dots-horizontal text-gray" />
                </div>
                <p className="tx-12 text-muted mb-3">
                  ...
                  considered projects. <a href="">Learn more</a>
                </p>
                <div className="table-responsive mb-0">
                  <table className="table table-hover table-bordered mb-0 text-md-nowrap text-lg-nowrap text-xl-nowrap table-striped ">
                    <thead>
                      <tr>
                        <th>Project</th>
                        <th>Team Members</th>
                    ...
                    <tbody>
                      <tr>
                        <td>
                          <div className="project-contain">
                            <h6 className="mb-1 tx-13">Angular Project</h6>
                          </div>
                        </td>
                        <td>
                        ...
                        <td>01 Jan 2020</td>
                        <td>
                          <span className="badge badge-primary-gradient">Ongoing</span>
                        </td>
                        <td>15 March 2020</td>
                      </tr>
                      <tr>
                        <td>
                          <div className="project-contain">
                            <h6 className="mb-1 tx-13">PHP Project</h6>
                          </div>
                        </td>
                        <td>
                          <div className="image-grouped">
                        ...
                        <td>03 March 2020</td>
                        <td>
                          <span className="badge badge-success-gradient">Ongoing</span>
                        </td>
                        <td>15 Jun 2020</td>
                      </tr>
                      <tr>
                        <td>
                          <div className="project-contain">
                            <h6 className="mb-1 tx-13">Python</h6>
                          </div>
                        </td>
                        <td>
                          <div className="image-grouped">
                        ...
                        <td>15 March 2020</td>
                        <td>
                          <span className="badge badge-danger-gradient">Pending</span>
                        </td>
                        <td>15 March 2020</td>
                      </tr>
                      <tr>
                        <td>
                          <div className="project-contain">
                            <h6 className="mb-1 tx-13">Android App</h6>
                          </div>
                        </td>
                        <td>
                          <div className="image-grouped">
                      ...
                      <tr>
                        <td>
                          <div className="project-contain">
                            <h6 className="mb-1 tx-13">Mobile Application</h6>
                          </div>
                        </td>
                        <td>
                          <div className="image-grouped">
                        ...
                        <td>15 March 2020</td>
                        <td>
                          <span className="badge badge-pink-gradient">Ongoing</span>
                        </td>
                        <td>15 March 2020</td>
                      </tr>
                    </tbody>
        ...
        <div className="row row-sm ">
          <div className="col-lg-12 col-xl-4 col-sm-12">
            <div className="card">
              <div className="card-header pb-0 pt-4">
                <div className="d-flex justify-content-between">
                  <h4 className="card-title mg-b-10">Top Ongoing Projects</h4>{' '}
                  <i className="mdi mdi-dots-horizontal text-gray" />
                </div>
                <p className="tx-12 text-muted mb-0">
                  Project Description is a formally written declaration of the project and its idea
                  and context . <a href="">Learn more</a>
                </p>
              </div>
              <div className="card-body p-0 m-scroll mh-350 mt-2">
                <div className="list-group projects-list">
                  ...
                  >
                    <div className="d-flex w-100 justify-content-between">
                      ...
                      <small className="text-danger">
                        <i className="fa fa-caret-down mr-1" />5 days ago
                      </small>
                    </div>
                    <p className="mb-0 text-muted mb-0 tx-12">Started:17-02-2020</p>
                  ...
                  >
                    <div className="d-flex w-100 justify-content-between">
                      <h6 className="mb-1 font-weight-semibold">Wordpress Projects</h6>{' '}
                      <small className="text-success">
                        <i className="fa fa-caret-up mr-1" />2 days ago
                      </small>
                    </div>
                    <p className="mb-0 text-muted mb-0 tx-12">Started:15-02-2020</p>
                    <small className="text-muted">
                      Lorem ipsum dolor sit amet, consectetuer adipiscing elit..
                    </small>
                  </a>{' '}
                  ...
                  >
                    <div className="d-flex w-100 justify-content-between">
                      <h6 className="mb-1 font-weight-semibold">HTML &amp; CSS3 Projects</h6>{' '}
                      <small className="text-danger">
                        <i className="fa fa-caret-down mr-1" />1 days ago
                      </small>
                    </div>
                    <p className="mb-0 text-muted mb-0 tx-12">Started:26-02-2020</p>
                    <small className="text-muted">
                      Lorem ipsum dolor sit amet, consectetuer adipiscing elit..
                    </small>
                  </a>{' '}
          ...
          <div className="col-xl-4 col-lg-6 col-md-12">
            <div className="card overflow-hidden ">
              <div className="card-header pb-0 pt-4">
                <div className="d-flex justify-content-between">
                  <h4 className="card-title mg-b-10 ">Activity</h4>{' '}
                  <i className="mdi mdi-dots-horizontal text-gray" />
                </div>
                <p className="tx-12 text-muted mb-0">
                  An activity is a scheduled phase in a project plan with a distinct beginning and
                  end. <a href="">Learn more</a>
                </p>
              </div>
              <div className="card-body p-0">
                <div className="activity Activity-scroll ps ps--active-y">
                  <div className="activity-list">
                    ...
                    <div className="time-activity ">
                      <div className="item-activity">
                        <p className="mb-0">
                          <span className="h6 mr-1">Adam Berry</span>
                          <span className="text-muted tx-13"> Add a new projects</span>{' '}
                          <span className="h6 ml-1 added-project"> AngularJS Template</span>
                        </p>
                    ...
                    <div className="time-activity">
                      <div className="item-activity">
                        <p className="mb-0">
                          <span className="h6 mr-1">Irene Hunter</span>{' '}
                          <span className="text-muted tx-13"> Add a new projects</span>{' '}
                          <span className="h6 ml-1 added-project text-danger">
                            Free HTML Template
                          </span>
                        </p>
                    ...
                    <div className="time-activity">
                      <div className="item-activity">
                        <p className="mb-0">
                          <span className="h6 mr-1">John Payne</span>{' '}
                          <span className="text-muted tx-13"> Add a new projects</span>{' '}
                          <span className="h6 ml-1 added-project text-success">
                            Free PSD Template
                          </span>
                        </p>
                    ...
                    <div className="time-activity">
                      <div className="item-activity ">
                        <p className="mb-0">
                          <span className="h6 mr-1">Julia Hardacre</span>{' '}
                          <span className="text-muted tx-13"> Add a new projects</span>{' '}
                          <span className="h6 ml-1 added-project text-warning">
                            Free UI Template
                          </span>
                        </p>
                    ...
                    <div className="time-activity">
                      <div className="item-activity">
                        <p className="mb-0">
                          <span className="h6 mr-1">Adam Berry</span>{' '}
                          <span className="text-muted tx-13"> Add a new projects</span>{' '}
                          <span className="h6 ml-1 added-project text-pink">
                            {' '}
                            AngularJS Template
                          </span>
                        </p>
                    ...
                    <div className="time-activity">
                      <div className="item-activity">
                        <p className="mb-0">
                          <span className="h6 mr-1">Irene Hunter</span>{' '}
                          <span className="text-muted tx-13"> Add a new projects</span>{' '}
                          <span className="h6 ml-1 added-project text-purple">
                            Free HTML Template
                          </span>
                        </p>
                        <small className="text-muted ">1 days ago</small>
                    ...
                    <div className="time-activity mb-0">
                      <div className="item-activity mb-0">
                        <p className="mb-0">
                          <span className="h6 mr-1">Julia Hardacre</span>
                          <span className="text-muted tx-13"> Add a new projects</span>
                          <span className="h6 ml-1 added-project">Free UI Template</span>
                        </p>
                        <small className="text-muted ">5 days ago</small>
                      </div>
                    </div>
                  ...
                  <div className="ps__rail-y" style={{ top: '0px', height: '344px', right: '0px' }}>
                    <div
                      className="ps__thumb-y"
                      tabIndex={0}
                      style={{ top: '0px', height: '173px' }}
                    />
                  </div>
                </div>
              </div>
          ...
          <div className="col-md-12 col-lg-6 col-xl-4">
            <div className="card">
              <div className="card-header pt-4 pb-0">
                <div className="d-flex justify-content-between">
                  <h4 className="card-title mg-b-10 ">Task Statistics</h4>{' '}
                  <i className="mdi mdi-dots-horizontal text-gray" />
                </div>
                <p className="tx-12 text-muted mb-0">
                  The Statistics You can also summarize your data in a graphical display, such as
                  histograms <a href="">Learn more</a>{' '}
                </p>
              </div>
                  ...
                  <div className="row">
                    <div className="col-md-6 col-6 text-center">
                      <div className="task-box primary mb-0">
                        <p className="mb-0 tx-12">Total Tasks</p>
                        <h3 className="mb-0">385</h3>
                      </div>
                    </div>
                    <div className="col-md-6 col-6 text-center">
                      <div className="task-box danger  mb-0">
                        <p className="mb-0 tx-12">Overdue Tasks</p>
              ...
              <div className="task-stat pb-0">
                <div className="d-flex tasks">
                  <div className="mb-0">
                    <div className="h6 fs-15 mb-0">
                      <i className="far fa-dot-circle text-primary mr-2" />
                      Completed Tasks
                    </div>{' '}
                    <span className="text-muted tx-11 ml-4">8:00am - 10:30am</span>
                  </div>{' '}
                  <span className="float-right ml-auto">135</span>
                </div>
                <div className="d-flex tasks">
                  <div className="mb-0">
                    <div className="h6 fs-15 mb-0">
                      <i className="far fa-dot-circle text-pink mr-2" />
                      Inprogress Tasks
                    </div>{' '}
                    <span className="text-muted tx-11 ml-4">8:00am - 10:30am</span>
                  </div>{' '}
                  <span className="float-right ml-auto">75</span>
                </div>
                <div className="d-flex tasks">
                  <div className="mb-0">
                    <div className="h6 fs-15 mb-0">
                      <i className="far fa-dot-circle text-success mr-2" />
                      On Hold Tasks
                    </div>{' '}
                    <span className="text-muted tx-11 ml-4">8:00am - 10:30am</span>
                  </div>{' '}
                  <span className="float-right ml-auto">23</span>
                </div>
                <div className="d-flex tasks mb-0 border-bottom-0">
                  <div className="mb-0">
                    <div className="h6 fs-15 mb-0">
                      <i className="far fa-dot-circle text-purple mr-2" />
                      Pending Tasks
                    </div>{' '}
                    <span className="text-muted tx-11 ml-4">8:00am - 10:30am</span>
                  </div>{' '}
                  <span className="float-right ml-auto">1</span>
                </div>
              </div>
            </div>
          </div>
